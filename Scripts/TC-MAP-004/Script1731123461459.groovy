...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/th_2024'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/span_2020'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/span_Oct'))
...
WebUI.verifyTextPresent('Input valid date', false)
